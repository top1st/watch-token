...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://top1st.github.io/watch-token' }],
    ['meta', { property: 'og:image', content: 'https://top1st.github.io/watch-token/assets/images/watch-token.jpg' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://top1st.github.io/watch-token/assets/images/watch-token.jpg' }], // eslint-disable-line max-len
